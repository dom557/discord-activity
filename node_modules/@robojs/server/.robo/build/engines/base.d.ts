...
export declare abstract class BaseEngine {
     ...
     */
    abstract getHttpServer(): Server | null;
    /**
     ...
     */
    abstract registerRoute(path: string, handler: RouteHandler): void | Promise<void>;
    abstract registerWebsocket(path: string, handler: WebSocketHandler): void | Promise<void>;
    abstract setupVite(vite: ViteDevServer): void | Promise<void>;
    /**
